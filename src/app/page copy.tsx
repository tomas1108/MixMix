  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div className="flex flex-col lg:flex-row relative">
        {/* Left Sidebar */}
        <section className={`lg:w-1/5 w-4/5 p-1 rounded-lg shadow-lg space-y-4 h-screen overflow-auto 
                             ${isLeftSidebarOpen ? 'absolute left-0 top-0 z-10 bg-white' : 'hidden'} 
                             lg:relative lg:block` }  style={{height: 'calc(100vh - 115px'}}>
          {/* Grid buttons */}
          <div>
            {/* Top Buttons */}
        ...
        {/* Middle Section */}
        <section className="lg:w-3/5 w-full bg-white rounded-lg shadow h-screen overflow-y-auto space-y-4 flex flex-col"  style={{height: 'calc(100vh - 115px'}}>
          {/* Banner */}
        ...
        {/* Right Sidebar */}
        <section className={`lg:w-1/5 w-4/5 bg-white p-4 rounded-lg shadow h-screen overflow-auto space-y-4 
                             ${isRightSidebarOpen ? 'absolute right-0 top-0 z-10' : 'hidden'} 
                             lg:relative lg:block `}  style={{height: 'calc(100vh - 115px'}}>
          {/* Login Form */}
